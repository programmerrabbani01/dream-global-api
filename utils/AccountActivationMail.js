...
const AccountActivationEmail = async (email, data) => {
  // create transport
...
<div align="center" class="alignment" style="line-height:10px"><img alt="I'm an image" src="https://static-00.iconduck.com/assets.00/messenger-icon-512x512-5pi1qivq.png" style="display: block; height: auto; border: 0; max-width: 120px; width: 100%;" title="I'm an image" width="120"/></div>
</td>
</tr>
</table>
...
<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><em><strong>Please Active Your Account</strong></em></p>
</div>
</div>
</td>
</tr>
...
<tr>
<td class="pad">
<div align="center" class="alignment"><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:42px;width:99px;v-text-anchor:middle;" arcsize="10%" stroke="false" fillcolor="#3AAEE0"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px"><![endif]-->
